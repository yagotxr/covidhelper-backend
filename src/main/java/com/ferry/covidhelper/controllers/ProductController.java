...
//    public Product registerProduct(@RequestBody ProductRegistrationRequest productRegistrationRequest,
//                                   @PathVariable("id") String storeId){
//
//        Store store = storeService.find(storeId);
//        Product product = Product.of(productRegistrationRequest, store);
